...
ChatGPTやGeminiの画像生成は本当に高性能になり、誰でも数分で見栄えのするチラシを作れるようになりました。AIを積極的に使うこと自体は、とても良いことです。

ただ、最近は「AIで作った感」がはっきり伝わるデザインが目立ちます。先日も、私の住む町の議員選挙で配られていたチラシの多くが、ひと目でAIと分かるデザインでした。デザインそのものは整っているのに、なんとなく手抜きに見えてしまう。私自身、少し気持ち悪さを感じるようになっています。
...
AIは、指示されなかったところを、これまでに学んだ大量の画像の「よくある形」で補います。だから、何も決めずに頼むと、誰が作っても似たチラシになります。見る人が感じる手抜き感は、この「平均そのものの見た目」と「人が選んだり削ったりした跡がないこと」から来ています。
...
### 4. 細部が崩れていて、誰も確認していない

画像の中の日本語が、意味の通らない文字に化けていることがあります。小さな看板や、画面の中のチラシの文字、地図の地名などは特に崩れやすい部分です。

私は、これが手抜き感の決定打だと考えています。細部を誰も確認していないことが伝わると、「中身も同じくらいの確認で作っているのでは」という不信感につながるからです。
...
一方で、選挙、士業、医療、不動産のように**信頼が商品そのもの**の仕事では、話が変わります。こうした場面では、手間をかけたこと自体が「誠実さ」のサインとして読まれます。AIの平均的な見た目は「自分の言葉と顔で語っていない」と受け取られやすく、損をする度合いが大きくなります。

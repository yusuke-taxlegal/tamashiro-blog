...
## 漏洩経路の説明を1→4番の順に修正（2026-09-25）
- 「4番・2番・1番」の順だった説明を、箇条書きと同じ1〜4番の順に書き直し、抜けていた3番（事業者側保存→大手・法人プランを選ぶ）を追加

## 漏洩経路の挿絵を作り直し（2026-09-25）
- 送信前に手を止める絵（send-check）は意図が伝わりにくいとの指摘で廃止・削除
- 新: tamashiro-yusuke-worried-business-owner-leak-routes.webp（1〜4番を起きやすい順に大→小で並べ、玉城が最大の1番=人の送信ミスを指す）。正本v5・集合見本v2・悩める社長v1を参照、目視照合済み
